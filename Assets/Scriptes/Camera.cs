...
public class Camera : MonoBehaviour
{
    ...
    void Update()
    {
       ...
       position.x = 0f;//блокируем передвижение по оси
       transform.position = Vector3.Lerp(transform.position, position, speed * Time.deltaTime);//Плавное "скольжение" из одной точки в другую
    }
}
